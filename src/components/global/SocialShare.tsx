  ...
  return (
    <div className='mx-auto mt-2 flex w-full justify-start py-1'>
      ...
      <div className='flex flex-wrap items-center justify-center space-x-2 rounded-md px-4'>
        ...
        >
          <FaFacebookSquare className='h-auto w-8  text-[#1877f2]' />
        </a>
        <a
          rel='noreferrer'
          target='_blank'
        ...
        >
          <FaMastodon className='h-auto w-8  text-[#6364ff]' />
        </a>
        <a
          rel='noreferrer'
          target='_blank'
        ...
        >
          <FaRedditSquare className='h-auto w-8  text-[#ff4500]' />
        </a>
        <a
          rel='noreferrer'
          target='_blank'
        ...
        >
          <FaLinkedin className='h-auto w-8  text-[#0a66c2]' />
        </a>
        <a
          rel='noreferrer'
          target='_blank'
        ...
        >
          <FaPinterestSquare className='h-auto w-8  text-[#bd081c]' />
        </a>
        <a
          rel='noreferrer'
          target='_blank'
        ...
        >
          <FaTumblrSquare className='h-auto w-8  text-[#35465d]' />
        </a>
        <a
          rel='noreferrer'
          target='_blank'
        ...
        >
          <FaFlipboard className='h-auto w-8  text-[#e12828]' />
        </a>
        <a
          rel='noreferrer'
          target='_blank'
        ...
        <button onClick={() => navigator.clipboard.writeText(url)}>
          <FaCopy className='h-auto w-7  text-[#9370d5]' />
        </button>
      </div>
    </div>
  );
