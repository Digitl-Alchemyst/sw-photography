          ...
          {galleries.map((gallery, index) => (
            ...
            >
              <div className=' flex w-full flex-col items-center space-y-8 rounded-md border border-steeldark-400 bg-steelpolished-600/20 px-6 py-4 shadow-2xl shadow-steeldark-800 drop-shadow-lg'>
                <h2
                  className={`${Aerotis.className} text-4xl lg:text-xl xl:text-2xl dxl:text-3xl xxl:text-4xl text-steelpolished-400 underline decoration-steelpolished-600 underline-offset-4`}
                >
                  {gallery.title}
                </h2>
                <div className='relative h-72 md:h-64 lg:h-42 xl:h-62 dxl:h-72 xxl:h-98 w-full'>
                  <Image
