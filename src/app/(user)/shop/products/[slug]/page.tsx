  ...
  const mockProducts: Product[] = [
    {
      ...
      seo: {
        ...
        metaDescription: 'Beautiful mountain sunrise fine art print available in multiple sizes and materials',
    ...
    } as any,
    {
      ...
      seo: {
        ...
        metaDescription: 'Professional moody portrait presets for Lightroom - 15 unique presets for dramatic portraits',
      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <nav className="mb-8 text-sm">
          <ol className="flex items-center space-x-2 text-steelpolished-500">
            <li>
              <a href="/" className="hover:text-steelpolished-400 transition-colors">
                Home
              </a>
            </li>
            <li>/</li>
            <li>
              <a href="/shop" className="hover:text-steelpolished-400 transition-colors">
                Shop
              </a>
            </li>
            <li>/</li>
        ...
        <div className="mt-16 border-t border-steeldark-600 pt-12">
          <h2 className="text-2xl font-bold text-steelpolished-400 mb-8">You Might Also Like</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Placeholder for related products */}
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-steeldark-800 rounded-lg border border-steeldark-600 p-4">
                <div className="aspect-square bg-steeldark-700 rounded-lg mb-4 flex items-center justify-center text-steelpolished-500">
                  Related Product {i}
                </div>
                <h3 className="font-medium text-steelpolished-400 mb-2">Related Product {i}</h3>
                <p className="text-steelpolished-500 text-sm mb-3">Short description of related product</p>
