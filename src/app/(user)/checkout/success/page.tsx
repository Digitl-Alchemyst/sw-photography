    ...
    <main className="w-full bg-steeldark-600 text-steelpolished-400 min-h-screen">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-steelpolished-400 mb-4">
            Order Confirmed!
          </h1>
          <p className="text-xl text-steelpolished-500 mb-2">
        ...
        {/* Order Details */}
        <div className="bg-steeldark-800 rounded-lg border border-steeldark-600 p-8 mb-8">
          <h2 className="text-2xl font-semibold text-steelpolished-400 mb-6">What's Next?</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-steelpolished-500">Available for immediate download</p>
                </div>
              </div>
              
              <div className="bg-steeldark-700/50 rounded-lg p-4">
                <p className="text-steelpolished-500 mb-4">
                  Your digital products are ready! Check your email for download links, or access them from your account.
                </p>
                <div className="space-y-2">
                  <button className="w-full flex items-center justify-center gap-2 bg-accent text-white py-2 px-4 rounded-lg hover:bg-accent/90 transition-colors">
                    <Download size={16} />
                    Download Now
                  </button>
                  <p className="text-xs text-steelpolished-600 text-center">
        ...
        {/* Order Summary */}
        <div className="bg-steeldark-800 rounded-lg border border-steeldark-600 p-6 mb-8">
          <h3 className="text-lg font-semibold text-steelpolished-400 mb-4">Order Summary</h3>
          
          <div className="space-y-3">
            {/* Mock order items */}
            <div className="flex justify-between items-center py-2 border-b border-steeldark-600">
              <div>
                <h4 className="font-medium text-steelpolished-400">Mountain Sunrise Print</h4>
                <p className="text-sm text-steelpolished-500">8" x 10" on Premium Paper</p>
              </div>
        ...
        <div className="bg-steeldark-800 rounded-lg border border-steeldark-600 p-6 mb-8">
          ...
          <div className="space-y-4 text-steelpolished-500">
            <div>
              <h4 className="font-medium text-steelpolished-400 mb-1">Order Confirmation</h4>
              <p className="text-sm">
            ...
            <div>
              <h4 className="font-medium text-steelpolished-400 mb-1">Customer Support</h4>
              <p className="text-sm">
                If you have any questions about your order, please contact us at{' '}
                <a href="mailto:orders@swphotography.com" className="text-accent hover:text-accent/80">
            ...
            <div>
              <h4 className="font-medium text-steelpolished-400 mb-1">Returns & Exchanges</h4>
              <p className="text-sm">
                Physical products can be returned within 30 days. Digital products are non-refundable after download.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/shop">
            <button className="flex items-center justify-center gap-2 px-6 py-3 bg-accent text-white rounded-lg hover:bg-accent/90 transition-colors">
              Continue Shopping
              <ArrowRight size={16} />
            </button>
          </Link>
          ...
          <Link href="/">
            <button className="flex items-center justify-center gap-2 px-6 py-3 border border-steeldark-600 text-steelpolished-400 rounded-lg hover:border-steelpolished-400 transition-colors">
              <Home size={16} />
              Back to Home
            </button>
          </Link>
        ...
        <div className="mt-12 text-center">
          <div className="bg-steeldark-800 rounded-lg border border-steeldark-600 p-8">
            <h3 className="text-xl font-semibold text-steelpolished-400 mb-4">
              Stay Updated
            </h3>
